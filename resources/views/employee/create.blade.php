                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method='POST' action='{{ route("employee.store") }}'>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="cin" value="{{ old('cin') }}" class="form-control" id="exampleInputEmail3" placeholder="adresse">
                      @error('cin')
                        <span class="badge badge-danger col-md-12" role="alert">
                          <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="telphone" value="{{ old('telphone') }}" class="form-control" id="exampleInputEmail3" placeholder="adresse">
                        @error('telphone')
                          <span class="badge badge-danger col-md-12" role="alert">
                            <strong>{{ $message }}</strong>
                          </span>
